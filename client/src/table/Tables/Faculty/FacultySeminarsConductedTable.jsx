...
export default function FacultySeminarsConductedTable() {
  ...
  useEffect(() => {
    const fetchTeacherInfo = async () => {
      try {
        ...
        const response = await axios.get(
          `https://faculty-appraisal-portal.vercel.app/api/v1/seminars/conducted`,
          {
            headers: {
  ...
  const handleDeleteRow = async () => {
    try {
      ...
      await axios.delete(
        `https://faculty-appraisal-portal.vercel.app/api/v1/seminars/${rowToDelete._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          ...
          try {
            if (rowToEdit) {
              ...
              const response = await axios.put(
                `https://faculty-appraisal-portal.vercel.app/api/v1/seminars/${rowToEdit._id}/edit`,
                formData,
                {
                  headers: {
                    Authorization: `Bearer ${token}`,
              ...
              const response = await axios.post(
                `https://faculty-appraisal-portal.vercel.app/api/v1/seminars/seminars/conducted`,
                formData,
                {
                  headers: {
                    Authorization: `Bearer ${token}`,
