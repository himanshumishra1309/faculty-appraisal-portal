  ...
  useEffect(() => {
    const fetchPublicationData = async () => {
      try {
        ...
        const endpoints = [
          "https://faculty-appraisal-portal.vercel.app/api/v1/domain-points/admin/book",
          "https://faculty-appraisal-portal.vercel.app/api/v1/domain-points/admin/patent",
          "https://faculty-appraisal-portal.vercel.app/api/v1/domain-points/admin/journal",
          "https://faculty-appraisal-portal.vercel.app/api/v1/domain-points/admin/conference",
          "https://faculty-appraisal-portal.vercel.app/api/v1/domain-points/admin/chapter",
        ];
