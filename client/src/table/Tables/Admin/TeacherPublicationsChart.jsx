...
const TeacherPublicationsChart = ({ id }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const endpointMap = {
        Book: `https://faculty-appraisal-portal.vercel.app/api/v1/admins/book/${id}`,
        "Book Chapter": `https://faculty-appraisal-portal.vercel.app/api/v1/admins/chapter/${id}`,
        "Journal Article": `https://faculty-appraisal-portal.vercel.app/api/v1/admins/journal/${id}`,
        Patent: `https://faculty-appraisal-portal.vercel.app/api/v1/admins/patent/${id}`,
        "Conference Paper": `https://faculty-appraisal-portal.vercel.app/api/v1/admins/conference/${id}`,
      };
