...
export default function FacultyGuidedTable() {
    ...
    const fetchTeacherInfo = async () => {
      try {
        ...
        const [response1, response2] = await Promise.all([
          axios.get(
            `https://faculty-appraisal-portal.vercel.app/api/v1/student-guide/mtech-students`,
            {
              headers: {
          ...
          axios.get(`https://faculty-appraisal-portal.vercel.app/api/v1/student-guide/phd-students`, {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          }),
  ...
  const handleDeleteRow = async () => {
    try {
      ...
      await axios.delete(
        `https://faculty-appraisal-portal.vercel.app/api/v1/student-guide/${rowToDelete._id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          ...
          try {
            if (rowToEdit) {
              ...
              const response = await axios.put(
                `https://faculty-appraisal-portal.vercel.app/api/v1/student-guide/${rowToEdit._id}`,
                formData,
                {
                  headers: {
                    Authorization: `Bearer ${token}`,
              ...
              const response = await axios.post(
                `https://faculty-appraisal-portal.vercel.app/api/v1/student-guide/upload`,
                formData,
                {
                  headers: {
                    Authorization: `Bearer ${token}`,
